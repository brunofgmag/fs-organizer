...
namespace
{
    ...
    TreeNode LibraryTree()
    {
        ...
        node.path = kLibrary;
        node.children = {
            AddonNode("D:/MSFS 2024/Utilities/flybywire-externaltools-simbridge"),
...
void RepairPlanTest::OnlyBrokenEntriesEnterThePlan()
{
    const std::vector<DestinationEntry> entries = {
        Entry("E:/Flight Simulator 2024/Community/alive", "D:/MSFS 2024/Sceneries/alive",
              EntryClassification::Managed),
        Entry("E:/Flight Simulator 2024/Community/gone", "D:/Removed/gone",
              EntryClassification::Broken),
        Entry("E:/Flight Simulator 2024/Community/physical", {},
              EntryClassification::Unmanaged),
        Entry("E:/Flight Simulator 2024/Community/foreign", "C:/Elsewhere/foreign",
    ...
    QCOMPARE(plan.front().entry.path,
...
{
    const std::vector<DestinationEntry> entries = {
        Entry("E:/Flight Simulator 2024/Community/unplugged", "X:/Library/unplugged",
...
{
    const std::vector<DestinationEntry> entries = {
        Entry("E:/Flight Simulator 2024/Community/ours", "D:/MSFS 2024/Sceneries/ours",
              EntryClassification::Broken),
        Entry("E:/Flight Simulator 2024/Community/theirs", "C:/OtherTool/theirs",
              EntryClassification::Broken)
    };
...
void RepairPlanTest::RepointIsOfferedOnlyWhenAValidAddonSharesTheBaseName()
{
    const std::vector<DestinationEntry> entries = {
        ...
        Entry("E:/Flight Simulator 2024/Community/fs2crew-cmd-center",
              "D:/Old Library/fs2crew-cmd-center", EntryClassification::Broken)
    };
    ...
    QCOMPARE(plan[0].repointTo,
             std::optional<std::filesystem::path>(
                 "D:/MSFS 2024/Utilities/flybywire-externaltools-simbridge"));
