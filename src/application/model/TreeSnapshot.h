#ifndef FS_ORGANIZER_APPLICATION_MODEL_TREE_SNAPSHOT_H
#define FS_ORGANIZER_APPLICATION_MODEL_TREE_SNAPSHOT_H
...
#endif // FS_ORGANIZER_APPLICATION_MODEL_TREE_SNAPSHOT_H
