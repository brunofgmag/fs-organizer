...
QString Explain(const ImportResult result)
{
    ...
    case ImportResult::Cancelled:
        return QObject::tr("cancelada por você");
    case ImportResult::TheSimulatorIsRunning:
        return QObject::tr("o simulador está em execução");
    ...
    case ImportResult::SourceIsAReparsePoint:
        return QObject::tr("a entrada é um link, e não uma pasta de verdade");
    case ImportResult::CouldNotCheckFreeSpace:
        return QObject::tr("não foi possível consultar o espaço livre do volume de destino");
    case ImportResult::NotEnoughFreeSpace:
        return QObject::tr("não há espaço livre suficiente na biblioteca");
    ...
    case ImportResult::CouldNotMoveIntoPlace:
        return QObject::tr("não foi possível pôr a cópia no lugar definitivo");
    case ImportResult::CouldNotRemoveSource:
        return QObject::tr("não foi possível remover a pasta de origem");
    case ImportResult::CouldNotCreateLink:
        return QObject::tr("os arquivos já estão na biblioteca, mas o link não pôde ser criado");
    case ImportResult::TheOriginIsUnknown:
        return QObject::tr("o diário não sabe de onde isto veio");
    case ImportResult::CouldNotRestore:
        return QObject::tr("já existe alguma coisa no lugar de origem");
    case ImportResult::CouldNotDiscard:
        return QObject::tr("não foi possível descartar");
...
QString Describe(const LinkOperationResult& result)
{
    QString line = QStringLiteral("%1 — %2")
        .arg(AsText(result.addonFolder.filename()), Explain(result.outcome.Failure()));
...
QString NameOfImportStep(const OperationKind kind)
{
    ...
    case OperationKind::ImportCopyToStaging:
        return QObject::tr("Copiando para a biblioteca...");
    case OperationKind::ImportVerifyStaging:
        return QObject::tr("Conferindo se a cópia bate com a origem...");
    case OperationKind::ImportMoveIntoPlace:
        return QObject::tr("Pondo a cópia no lugar definitivo...");
    case OperationKind::ImportRemoveSource:
        return QObject::tr("Removendo a pasta de origem...");
    case OperationKind::EnableAddon:
        return QObject::tr("Criando o link no destino...");
    default:
        return {};
    }
}
