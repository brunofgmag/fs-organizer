#ifndef FS_ORGANIZER_VIEW_LIBRARY_SUGGESTION_DIALOG_H
#define FS_ORGANIZER_VIEW_LIBRARY_SUGGESTION_DIALOG_H
...
#endif // FS_ORGANIZER_VIEW_LIBRARY_SUGGESTION_DIALOG_H
