...
public:
    ...
    void CarryTriageOn(QWidget* page);

    void ShowTriage(std::size_t broken, std::size_t conflicts, std::size_t unmanaged);

    void ShowStatus(const QString& message);

    void ShowRestartPending(bool pending) const;

    void ShowSummary(QWidget* page, const QString& summary);

    void ShowAside(QWidget* page, const QString& aside);

    void ShowMeter(QWidget* page, int filled, int outOf);
...
private:
    ...
    void DressTheFooterFor(const QWidget* page);
